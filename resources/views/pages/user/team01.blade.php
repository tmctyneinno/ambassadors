  ...
  <div class="nicdark_filter greydark">
      ...
      <div class="nicdark_container nicdark_clearfix">
          <div class="grid grid_12">
              ...
              <h3 class="subtitle white">ERIN OMOTANWA SULAIMAN </h3>
  ...
  <section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <img alt="" class="nicdark_radius nicdark_opacity" style="float:left;width:100%;" src=" {{ asset('assets/team/team01.jpg')}}">
        ...
        <div class="grid grid_6">
            <h3 class="subtitle greydark">ERIN OMOTANWA SULAIMAN</h3>
            <div class="nicdark_space20"></div>
